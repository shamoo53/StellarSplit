#!/bin/bash
# Build the Achievement Badges Soroban contract to WASM

set -e

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
CONTRACT_DIR="$SCRIPT_DIR/../achievement-badges"
TARGET_DIR="$SCRIPT_DIR/../target"

echo "🔨 Building achievement-badges contract..."
...
WASM_PATH="$CONTRACT_DIR/target/wasm32-unknown-unknown/release/achievement_badges.wasm"
